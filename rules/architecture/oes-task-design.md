...
**环境(E)**:
- **代码相关**:
  - `packages/core/src/core/parsing/XMLParser.ts` - 基础解析器实现
  - `packages/core/src/core/parsing/XMLAdapter.ts` - 适配器实现
  - `packages/core/src/core/parsing/DPMLAdapter.ts` - DPML适配器实现
