 ...
 */
export function waitForEvent<T, E extends { on: (event: string, handler: (data: T) => void) => void; off: (event: string, handler: (data: T) => void) => void }>(
  emitter: E,
  eventName: string,
  options: {
    timeout?: number;
...
export function createCancellablePromise<T>(
  executor: (resolve: (value: T) => void, reject: (reason: any) => void, onCancel: (handler: () => void) => void) => void
