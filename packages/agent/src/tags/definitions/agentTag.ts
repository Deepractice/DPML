import { Element, ValidationResult, ValidationError, ValidationWarning, isElement } from '@dpml/core';

/**
 * agent标签验证函数
 */
export function validateAgentTag(element: Element, context: any): ValidationResult {
  ...
  const hasPrompt = element.children.some((child: any) => 
