...
import { AgentErrorCode } from '../../../src/errors/types';
import { AgentStateManagerFactory } from '../../../src/state/AgentStateManagerFactory';
import { Agent } from '../../../src/agent/types';

// 创建错误工厂mock 
vi.mock('../../../src/errors/factory', () => {
...
// 模拟状态管理器工厂
vi.mock('../../../src/state/AgentStateManagerFactory', () => ({
...
// 模拟记忆工厂
vi.mock('../../../src/memory/AgentMemoryFactory', () => ({
  AgentMemoryFactory: {
