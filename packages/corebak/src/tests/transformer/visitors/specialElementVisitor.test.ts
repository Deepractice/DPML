...
describe('SpecialElementVisitor', () => {
  ...
  it('应该处理图片元素', async () => {
    ...
    expect(result.meta).toHaveProperty('dimensions', {
      width: 300,
      height: 200,
    });
  });
  ...
  it('应该处理表格元素', async () => {
    ...
    const cellContent1: Content = {
      ...
      position: {
        ...
        end: { line: 2, column: 10, offset: 25 },
      },
    };
    ...
    const cellContent2: Content = {
      ...
      value: '年龄',
      position: {
        start: { line: 2, column: 15, offset: 30 },
    ...
    const cellContent4: Content = {
      ...
      value: '25',
      position: {
        start: { line: 3, column: 15, offset: 55 },
    ...
    const cell1 = {
      ...
      position: {
        start: { line: 2, column: 3, offset: 18 },
        end: { line: 2, column: 12, offset: 27 },
      },
    };
    ...
    const cell2 = {
      ...
      position: {
        start: { line: 2, column: 13, offset: 28 },
        end: { line: 2, column: 22, offset: 37 },
      },
    };
    ...
    const cell3 = {
      ...
      position: {
        start: { line: 3, column: 3, offset: 43 },
        end: { line: 3, column: 12, offset: 52 },
      },
    };
    ...
    const cell4 = {
      ...
      position: {
        start: { line: 3, column: 13, offset: 53 },
        end: { line: 3, column: 22, offset: 62 },
      },
    };
    ...
    const headerRow = {
      ...
      position: {
        ...
        end: { line: 2, column: 24, offset: 39 },
      },
    };
    ...
    const dataRow = {
      ...
      position: {
        ...
        end: { line: 3, column: 24, offset: 64 },
      },
    };
    ...
    const tableHead = {
      ...
      children: [headerRow],
      position: {
        start: { line: 1, column: 3, offset: 5 },
        end: { line: 2, column: 26, offset: 41 },
      },
    };
    ...
    const tableBody = {
      ...
      children: [dataRow],
      position: {
        start: { line: 2, column: 3, offset: 43 },
        end: { line: 3, column: 26, offset: 66 },
      },
    };
  ...
  it('应该处理列表元素', async () => {
    ...
    const item2Content: Content = {
      ...
      value: '第二项',
      position: {
        start: { line: 3, column: 5, offset: 35 },
        end: { line: 3, column: 10, offset: 40 },
      },
    };
    ...
    const item3Content: Content = {
      ...
      value: '第三项',
      position: {
        start: { line: 4, column: 5, offset: 50 },
        end: { line: 4, column: 10, offset: 55 },
      },
    };
    ...
    const item2 = {
      ...
      position: {
        ...
        end: { line: 3, column: 12, offset: 42 },
      },
    };
    ...
    const item3 = {
      ...
      position: {
        start: { line: 4, column: 3, offset: 48 },
        end: { line: 4, column: 12, offset: 57 },
      },
    };
  ...
  it('应该处理引用块元素', async () => {
    ...
    const p1 = {
      ...
      position: {
        start: { line: 2, column: 3, offset: 18 },
        end: { line: 2, column: 17, offset: 32 },
      },
    };
    ...
    const p2 = {
      ...
      position: {
        ...
        end: { line: 3, column: 17, offset: 52 },
      },
    };
  ...
  it('应该递归处理嵌套特殊元素', async () => {
    ...
    const nestedContentNode: Content = {
      ...
      value: '嵌套代码',
      position: {
        start: { line: 3, column: 10, offset: 45 },
        end: { line: 3, column: 15, offset: 50 },
      },
    };
    ...
    const itemContent: Content = {
      ...
      value: '列表项: ',
      position: {
        start: { line: 3, column: 3, offset: 35 },
        end: { line: 3, column: 8, offset: 40 },
      },
    };
    ...
    const listItem = {
      ...
      position: {
        ...
        end: { line: 3, column: 22, offset: 57 },
      },
    };
