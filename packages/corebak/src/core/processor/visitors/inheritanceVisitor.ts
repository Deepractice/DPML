...
import { DPMLError, ErrorCode } from 'packages/corebak/src/errors';
import { NodeType, isElement } from 'packages/corebak/src/types/node';

import type { Element, Reference } from 'packages/corebak/src/types/node';
import type {
  NodeVisitor,
  ProcessingContext,
  ReferenceResolver,
