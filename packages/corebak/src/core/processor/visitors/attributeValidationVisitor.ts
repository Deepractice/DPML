...
import { DocumentMode } from 'packages/corebak/src/core/processor/visitors/documentMetadataVisitor';
import {
  ...
  ValidationResult,
  ValidationWarning,
} from 'packages/corebak/src/errors/types';
import { Document } from 'packages/corebak/src/types/node';

import type { ValidationErrorImpl } from 'packages/corebak/src/errors/types';
import type { TagRegistry } from '@core/parser/tag-registry';
import type { Element } from 'packages/corebak/src/types/node';
import type {
  NodeVisitor,
  ProcessingContext,
