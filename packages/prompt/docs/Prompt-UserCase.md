...
| 测试ID | 测试名称 | 测试意图 | 预期结果 |
|-------|---------|---------|---------|
| UT-RP-001 | 基本角色处理 | 测试角色基本属性处理 | 角色属性和内容被正确提取到元数据 |
| UT-RP-002 | 角色描述提取 | 测试角色描述文本提取 | 描述文本被正确提取到元数据 |
| UT-RP-003 | extends属性处理 | 测试角色继承处理 | 成功处理继承关系，合并属性和内容 |

### 2.3 ContextTagProcessor

| 测试ID | 测试名称 | 测试意图 | 预期结果 |
|-------|---------|---------|---------|
| UT-CP-001 | 基本上下文处理 | 测试上下文基本属性处理 | 上下文属性和内容被正确提取 |
| UT-CP-002 | 上下文内容提取 | 测试上下文文本提取 | 上下文文本被正确提取到元数据 |
| UT-CP-003 | extends属性处理 | 测试上下文继承处理 | 成功处理继承关系，合并属性和内容 |

### 2.4 ThinkingTagProcessor

| 测试ID | 测试名称 | 测试意图 | 预期结果 |
|-------|---------|---------|---------|
| UT-TP-001 | 基本思维处理 | 测试思维框架基本属性处理 | 思维框架属性和内容被正确提取 |
| UT-TP-002 | 思维内容提取 | 测试思维框架文本提取 | 思维框架文本被正确提取到元数据 |
| UT-TP-003 | extends属性处理 | 测试思维框架继承处理 | 成功处理继承关系，合并属性和内容 |

### 2.5 ExecutingTagProcessor

| 测试ID | 测试名称 | 测试意图 | 预期结果 |
|-------|---------|---------|---------|
| UT-EP-001 | 基本执行处理 | 测试执行步骤基本属性处理 | 执行步骤属性和内容被正确提取 |
| UT-EP-002 | 执行内容提取 | 测试执行步骤文本提取 | 执行步骤文本被正确提取到元数据 |
| UT-EP-003 | extends属性处理 | 测试执行步骤继承处理 | 成功处理继承关系，合并属性和内容 |

### 2.6 TestingTagProcessor

| 测试ID | 测试名称 | 测试意图 | 预期结果 |
|-------|---------|---------|---------|
| UT-TTP-001 | 基本测试处理 | 测试质量检查基本属性处理 | 质量检查属性和内容被正确提取 |
| UT-TTP-002 | 测试内容提取 | 测试质量检查文本提取 | 质量检查文本被正确提取到元数据 |
| UT-TTP-003 | extends属性处理 | 测试质量检查继承处理 | 成功处理继承关系，合并属性和内容 |

### 2.7 ProtocolTagProcessor

| 测试ID | 测试名称 | 测试意图 | 预期结果 |
|-------|---------|---------|---------|
| UT-PRP-001 | 基本协议处理 | 测试交互协议基本属性处理 | 交互协议属性和内容被正确提取 |
| UT-PRP-002 | 协议内容提取 | 测试交互协议文本提取 | 交互协议文本被正确提取到元数据 |
| UT-PRP-003 | extends属性处理 | 测试交互协议继承处理 | 成功处理继承关系，合并属性和内容 |

### 2.8 CustomTagProcessor

| 测试ID | 测试名称 | 测试意图 | 预期结果 |
|-------|---------|---------|---------|
| UT-CTP-001 | 基本自定义内容处理 | 测试自定义内容基本属性处理 | 自定义内容属性和内容被正确提取 |
| UT-CTP-002 | 最小干预策略 | 测试最小干预处理原则 | 自定义内容被原样保留，最小处理 |
| UT-CTP-003 | extends属性处理 | 测试自定义内容继承处理 | 成功处理继承关系，合并属性和内容 |
