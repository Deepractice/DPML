...
- [ ] 编写基本转换功能测试 (UT-PT-001)
- [ ] 实现基本转换功能
- [ ] 编写标签序列化测试 (UT-PT-002)
- [ ] 实现各标签序列化成文本
- [ ] 编写转换选项配置测试 (UT-PT-003)
- [ ] 实现转换选项影响逻辑
- [ ] 编写空值处理测试 (UT-PT-004)
- [ ] 实现空标签和空内容处理
- [ ] 编写Markdown转换测试 (UT-PT-005)
- [ ] 实现Markdown内容转换

## 13. 格式配置功能

- [ ] 编写默认格式应用测试 (UT-FC-001)
- [ ] 实现默认格式模板
- [ ] 编写自定义格式模板测试 (UT-FC-002)
- [ ] 实现自定义格式覆盖逻辑
- [ ] 编写标题前缀后缀测试 (UT-FC-003)
- [ ] 实现标题、前缀、后缀应用
- [ ] 编写内容包装器测试 (UT-FC-004)
- [ ] 实现包装器函数处理
- [ ] 编写标签顺序定制测试 (UT-FC-005)
- [ ] 实现按指定顺序组织标签
- [ ] 编写部分格式覆盖测试 (UT-FC-006)
- [ ] 实现部分标签格式覆盖逻辑
