...
import { NodeType, Reference } from '../../../src/types/node';
...
import { ReferenceVisitor } from '../../../src/transformer/visitors/referenceVisitor';
...
describe('ReferenceVisitor', () => {
  ...
  it('应该正确处理嵌套引用', () => {
    ...
    const nestedReference: Reference = {
      ...
      protocol: 'id',
      path: 'nested-ref',
      position: { start: { line: 2, column: 1, offset: 20 }, end: { line: 2, column: 10, offset: 29 } },
    ...
    const document: ProcessedDocument = {
      ...
      position: { start: { line: 0, column: 0, offset: 0 }, end: { line: 3, column: 0, offset: 40 } }
    };
