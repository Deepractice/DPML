...
import { ElementVisitor, ElementVisitorOptions } from '../../../src/transformer/visitors/elementVisitor';
...
describe('ElementVisitor', () => {
  ...
  it('应该处理嵌套元素和内容', async () => {
    ...
    const contentNode = {
      ...
      value: '这是一段文本',
      position: { start: { line: 2, column: 3, offset: 10 }, end: { line: 2, column: 10, offset: 17 } }
    };
    ...
    const childElement = {
      ...
      position: { start: { line: 2, column: 1, offset: 8 }, end: { line: 2, column: 30, offset: 37 } }
    };
    ...
    const parentElement = {
      ...
      position: { start: { line: 1, column: 1, offset: 0 }, end: { line: 3, column: 1, offset: 45 } }
    };
  ...
  it('应该处理不同类型的特殊元素', async () => {
    ...
    const elements = [
      {
        ...
        children: [
          { type: NodeType.CONTENT, value: 'const x = 1;' }
        ],
        position: { start: { line: 1, column: 1, offset: 0 }, end: { line: 1, column: 20, offset: 19 } }
      },
      {
        ...
        children: [
          { type: NodeType.CONTENT, value: '示例链接' }
        ],
        position: { start: { line: 2, column: 1, offset: 20 }, end: { line: 2, column: 20, offset: 39 } }
      },
      {
        type: NodeType.ELEMENT,
        tagName: 'list',
        ...
        position: { start: { line: 3, column: 1, offset: 40 }, end: { line: 3, column: 20, offset: 59 } }
      }
    ];
    ...
    const document: ProcessedDocument = {
      type: NodeType.DOCUMENT,
      children: elements,
      position: { start: { line: 0, column: 0, offset: 0 }, end: { line: 4, column: 0, offset: 60 } }
    };
  ...
  it('应该处理元素类名转换', async () => {
    ...
    // 验证
    expect(result).not.toBe(null);
    expect(result.attributes).toHaveProperty('class', 'container primary large');
    expect(result).toHaveProperty('meta');
