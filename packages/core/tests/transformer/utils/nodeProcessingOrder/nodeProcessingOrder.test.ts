              ...
              children: [
                {
                  ...
                  position: { start: { line: 4, column: 1, offset: 0 }, end: { line: 4, column: 15, offset: 14 } }
                }
              ],
              position: { start: { line: 3, column: 1, offset: 0 }, end: { line: 5, column: 1, offset: 0 } }
            },
            {
              type: NodeType.ELEMENT,
              tagName: 'child2',
              ...
              children: [
                {
                  ...
                  position: { start: { line: 7, column: 1, offset: 0 }, end: { line: 7, column: 15, offset: 14 } }
                }
              ],
              position: { start: { line: 6, column: 1, offset: 0 }, end: { line: 8, column: 1, offset: 0 } }
            }
          ],
          position: { start: { line: 2, column: 1, offset: 0 }, end: { line: 9, column: 1, offset: 0 } }
        }
      ],
      position: { start: { line: 1, column: 1, offset: 0 }, end: { line: 10, column: 1, offset: 0 } }
    };
  };
          ...
          children: [
            {
              type: NodeType.CONTENT,
              value: 'Test content',
              position: { start: { line: 3, column: 1, offset: 0 }, end: { line: 3, column: 12, offset: 11 } }
            }
          ],
          position: { start: { line: 2, column: 1, offset: 0 }, end: { line: 4, column: 1, offset: 0 } }
        }
      ],
      position: { start: { line: 1, column: 1, offset: 0 }, end: { line: 5, column: 1, offset: 0 } }
    };
