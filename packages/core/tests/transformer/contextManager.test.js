...
describe('ContextManager', () => {
    ...
    describe('创建上下文', () => {
        ...
        it('应该能创建子上下文', () => {
            ...
            const rootContext = contextManager.createRootContext(mockDocument, mockOptions);
            // 创建子上下文
            const childContext = contextManager.createChildContext(rootContext, 'section', { sectionTitle: '第一章' });
            // 验证子上下文属性
        ...
        it('应该能嵌套创建多级上下文', () => {
            ...
            const rootContext = contextManager.createRootContext(mockDocument, mockOptions);
            // 创建第一级子上下文
            const level1Context = contextManager.createChildContext(rootContext, 'section[1]', { sectionTitle: '第一章' });
            // 创建第二级子上下文
            const level2Context = contextManager.createChildContext(level1Context, 'paragraph[1]', { paragraphStyle: 'normal' });
            // 验证层级关系
