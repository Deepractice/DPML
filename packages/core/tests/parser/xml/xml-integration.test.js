...
import { XMLParserAdapter, XMLToNodeConverter } from '../../../src/parser/xml';
...
describe('XML解析与转换集成测试', () => {
  ...
  <section id="intro">
    ...
    <paragraph>DPML是一种用于定义提示的标记语言</paragraph>
        ...
        expect(heading.children[0].value).toBe('DPML简介');
        const paragraph = section.children[1];
        expect(paragraph.tagName).toBe('paragraph');
        expect(paragraph.children).toHaveLength(1);
        expect(paragraph.children[0].value).toBe('DPML是一种用于定义提示的标记语言');
    });
    it('应该正确处理空标签和自闭合标签', () => {
        const xmlText = `<document>
  <prompt>
  ...
  <section>
    <heading>位置测试</heading>
        ...
        const section = dpmlNode.children[0];
...
//# sourceMappingURL=xml-integration.test.js.map