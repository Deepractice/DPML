...
describe('DefaultReferenceResolver', () => {
    ...
    let mockFileHandler;
    let mockIdHandler;
    const createMockReference = (protocol, path) => ({
    ...
    beforeEach(() => {
        ...
        mockHttpHandler = {
            ...
            handle: vi.fn().mockImplementation(async (reference) => ({
...
//# sourceMappingURL=defaultReferenceResolver.test.js.map