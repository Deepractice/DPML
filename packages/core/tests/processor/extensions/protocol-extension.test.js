...
class VersionedFileProtocolHandler {
    constructor() {
        this.protocol = 'vfile';
    }
    canHandle(protocol) {
...
//# sourceMappingURL=protocol-extension.test.js.map