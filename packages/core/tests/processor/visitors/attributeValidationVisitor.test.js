...
describe('AttributeValidationVisitor', () => {
    ...
    it('应该识别未知属性', async () => {
        ...
        warnSpy.mockRestore();
        // 验证以x-开头的扩展属性不会触发警告
        const extensionAttributeElement = {
            type: NodeType.ELEMENT,
            tagName: 'role',
            attributes: {
                name: 'test',
...
//# sourceMappingURL=attributeValidationVisitor.test.js.map