...
describe('InheritanceVisitor', () => {
    ...
    it('应该从给定ID继承属性', async () => {
        ...
        // 将基础元素添加到ID映射中
        context.idMap.set('baseEl', baseElement);
        // 执行访问方法
    ...
    it('应该处理继承错误情况', async () => {
        ...
        // 将元素添加到ID映射中
        context.idMap.set('el1', element1);
        context.idMap.set('el2', element2);
        // 设置继承链以模拟第一次引用已处理
...
//# sourceMappingURL=inheritanceVisitor.test.js.map