...
describe('IdProtocolHandler', () => {
    ...
    it('应该可以多次设置上下文', () => {
        const context1 = { processingContext: {} };
        const context2 = { processingContext: {} };
        handler.setContext(context1);
        expect(handler.context).toBe(context1);
        handler.setContext(context2);
        expect(handler.context).toBe(context2);
    });
});
//# sourceMappingURL=idProtocolHandler.test.js.map