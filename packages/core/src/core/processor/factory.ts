...
import { DefaultProcessor } from '@core/core/processor/defaultProcessor';
import { DefaultReferenceResolver } from '@core/core/processor/defaultReferenceResolver';
import {
  createHttpProtocolHandler,
  createIdProtocolHandler,
  createFileProtocolHandler,
} from '@core/core/processor/protocols';
import {
  createIdValidationVisitor,
  createReferenceVisitor,
  createDocumentMetadataVisitor,
  DocumentMode,
} from '@core/core/processor/visitors';
import { DomainTagVisitor } from '@core/core/processor/visitors/domainTagVisitor';

import type { ProcessorOptions, ProcessorFactoryOptions } from '@core/types/processor';
