...
import { DocumentStructureVisitor } from '../../../transformer/visitors/documentStructureVisitor';
  ...
  const createTestDocument = (): ProcessedDocument => {
    return {
              ...
              children: [
                {
                  ...
                  value: '这是第一段内容',
                  position: {
                    start: { line: 3, column: 3, offset: 50 },
                    end: { line: 3, column: 23, offset: 70 },
                  },
                },
              ],
              position: {
                start: { line: 2, column: 2, offset: 30 },
                end: { line: 4, column: 2, offset: 80 },
              },
            },
            {
              type: NodeType.ELEMENT,
              ...
              children: [
                {
                  ...
                  value: '这是第二段内容',
                  position: {
                    start: { line: 6, column: 3, offset: 100 },
                    end: { line: 6, column: 23, offset: 120 },
                  },
                },
              ],
              position: {
                start: { line: 5, column: 2, offset: 90 },
                end: { line: 7, column: 2, offset: 130 },
              },
            },
          ],
          position: {
      ...
      position: {
        ...
        end: { line: 9, column: 0, offset: 160 },
      },
      metadata: {
        title: '测试文档',
        author: '开发者',
              ...
              children: [
                {
                  ...
                  position: {
                    start: { line: 2, column: 2, offset: 30 },
                    end: { line: 4, column: 2, offset: 60 },
                  },
                },
              ],
              position: {
                start: { line: 1, column: 1, offset: 20 },
                end: { line: 5, column: 1, offset: 70 },
              },
            },
          ],
          position: {
