...
import { UnknownElementVisitor } from '../../../transformer/visitors/unknownElementVisitor';
...
describe('UnknownElementVisitor', () => {
  ...
  it('应该递归处理嵌套的未知元素', async () => {
    ...
    const nestedUnknownElement = {
      ...
      children: [],
      position: {
        start: { line: 2, column: 3, offset: 25 },
        end: { line: 2, column: 30, offset: 52 },
      },
    };
    ...
    expect(processedParent.meta).toHaveProperty(
      'originalTag',
      'unknown-parent'
    );
