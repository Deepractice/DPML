...
import { 
  Node, Document, Element, Content, Reference,
  NodeType, isNode, isDocument, isElement, isContent, isReference 
} from '../../types/node';
...
describe('节点类型系统', () => {
  ...
  describe('基础节点类型', () => {
    ...
    it('应该可以区分不同类型的节点', () => {
      const node: Node = { type: NodeType.ELEMENT, position: { start: { line: 1, column: 1, offset: 0 }, end: { line: 1, column: 10, offset: 9 } } };
      expect(isNode(node)).toBe(true);
