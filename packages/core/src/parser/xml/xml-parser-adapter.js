...
export class XMLParserAdapter {
     ...
     */
    processRootElement(rootElement, xmlText, lineOffsets) {
        // 获取根标签名（排除特殊属性键）
     ...
     * @returns 创建的子节点
     */
    processChildElement(tagName, element, xmlText, lineOffsets) {
        const childNode = {
            name: tagName,
            children: []
        };
     ...
     * @returns 行号（从1开始）
     */
    getLineFromOffset(offset, lineOffsets) {
     ...
     * @param lineOffsets 行偏移量数组
     */
    addPositionToChildren(children, xmlText, lineOffsets) {
...
//# sourceMappingURL=xml-parser-adapter.js.map