/**
 * TagRegistryService单元测试
 */
import { describe, test, expect, beforeEach, afterEach } from 'vitest';

import { getGlobalTagRegistry, resetGlobalTagRegistry, createTagRegistry } from '../../../../core/parser/TagRegistryService';
import { ContentModel } from '../../../../types';
import type { TagDefinition, TagRegistry } from '../../../../types';

describe('UT-Parser-TagRegService', () => {
  // 每个测试后重置全局注册表
  afterEach(() => {
